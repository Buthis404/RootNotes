...
class StructuredResult:
    ...
    access_role: Optional[str] = None   # local_admin | domain_admin | user | read | shell
    ...
    finding_candidates: list = field(default_factory=list)  # [{"type","title","severity","host_id","cred_id","details"}]
