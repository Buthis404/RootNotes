...
_CAT_ATTACK_PATHS = "Attack Paths"
...
TEMPLATES = {
    ...
    "internal-network": {
        ...
        "checklist": [
            ...
            (_CAT_INITIAL_ACCESS, "Credential spraying against identified services"),
            (_CAT_INITIAL_ACCESS, "Exploit unpatched services"),
            (_CAT_INITIAL_ACCESS, "Phishing simulation (if in scope)"),
            (_CAT_LATERAL_MOVEMENT, "Pass-the-Hash / Pass-the-Ticket"),
            (_CAT_LATERAL_MOVEMENT, "WMI / PSExec / SMB lateral movement"),
            (_CAT_LATERAL_MOVEMENT, "Kerberoasting"),
    ...
    "active-directory": {
        ...
        "checklist": [
            ...
            (_CAT_ATTACK_PATHS, "AS-REP Roasting"),
            (_CAT_ATTACK_PATHS, "Kerberoasting (SPN accounts)"),
            (_CAT_ATTACK_PATHS, "Password spraying against AD"),
            (_CAT_ATTACK_PATHS, "ACL abuse (GenericAll, WriteDACL, etc.)"),
            (_CAT_ATTACK_PATHS, "DCSync attack path"),
            (_CAT_ATTACK_PATHS, "Silver / Golden ticket feasibility"),
            (_CAT_ATTACK_PATHS, "ADCS / Certificate abuse (ESC1-ESC8)"),
            (_CAT_ATTACK_PATHS, "LAPS review"),
            (_CAT_ATTACK_PATHS, "Unconstrained / constrained delegation"),
            (_CAT_ATTACK_PATHS, "PrintNightmare / other print spooler attacks"),
...
@router.post("/{template_id}/apply", status_code=201, responses={404: {"description": "Not found"}})
def apply_template(
    template_id: str,
