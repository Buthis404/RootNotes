...
def upgrade() -> None:
    ...
    op.execute(text("CREATE UNIQUE INDEX IF NOT EXISTS idx_pm_project_user ON project_members(project_id, user_id)"))
    op.execute(text("CREATE INDEX IF NOT EXISTS idx_projects_webhook_token ON projects(webhook_token) WHERE webhook_token <> ''"))
    ...
    op.execute(text("CREATE INDEX IF NOT EXISTS idx_findings_source ON findings(pid, source) WHERE source <> 'manual'"))
    op.execute(text("CREATE INDEX IF NOT EXISTS idx_loots_pid ON loots(pid)"))
    op.execute(text("CREATE INDEX IF NOT EXISTS idx_loots_job_id ON loots(job_id) WHERE job_id <> ''"))
    ...
    op.execute(text("CREATE INDEX IF NOT EXISTS idx_scheduled_playbooks_pid ON scheduled_playbooks(pid)"))
    ...
    op.execute(text("CREATE INDEX IF NOT EXISTS idx_host_activities_host_id ON host_activities(host_id)"))
    op.execute(text("CREATE INDEX IF NOT EXISTS idx_cred_host_notes_cred_id ON cred_host_notes(cred_id)"))
    op.execute(text("CREATE INDEX IF NOT EXISTS idx_cred_host_notes_host_id ON cred_host_notes(host_id)"))
    ...
    op.execute(text("CREATE INDEX IF NOT EXISTS idx_timeline_events_ts ON timeline_events(ts DESC)"))
