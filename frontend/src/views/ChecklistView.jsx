      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <div style={{ width: 180, background: '#0a0c10', borderLeft: '1px solid #1a1c22', padding: '16px 14px', flexShrink: 0, overflowY: 'auto' }}>
          ...
          {PHASES.map(ph => {
            ...
            return (
              <button type="button" key={ph} onClick={() => setPhase(ph)} onKeyDown={e => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  setPhase(ph);
                }
              }}
              style={{ marginBottom: 12, cursor: 'pointer', padding: '6px 8px', borderRadius: 5, background: ph === phase ? `${c}12` : 'transparent', border: `1px solid ${ph === phase ? c + '44' : 'transparent'}`, width: '100%', textAlign: 'left', outline: 'none', color: 'inherit', font: 'inherit' }}>
