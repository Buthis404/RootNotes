...
function ValidateCredPanel({ cred, projectHosts, selectedProject, accent, onClose }) {
  ...
  return (
    <div style={{ background: '#0a0c12', border: `1px solid ${acc}33`, borderRadius: 6, padding: 12, marginTop: 10 }}>
      ...
      <button onClick={run} disabled={running || !moduleOk || !selectedHostIds.length}
        ...
        {running ? 'Validating…' : `Test on ${selectedHostIds.length} host${selectedHostIds.length !== 1 ? 's' : ''}`}
      </button>
      ...
      {results && (
        <div style={{ marginTop: 8, display: 'flex', flexDirection: 'column', gap: 4 }}>
          {results.map((r, i) => {
            ...
            return (
              <div key={i} style={{ padding: '5px 8px', background: r.ok ? '#39d35312' : '#cc223312', border: `1px solid ${r.ok ? '#39d35333' : '#cc223333'}`, borderRadius: 4, fontSize: 10, fontFamily: 'JetBrains Mono' }}>
